...
export interface SubdomainFlowProps {
	step: string
}
 
export const SubdomainFlow: React.FC<SubdomainFlowProps> = ({ step }) => {
  ...
  return (
    <>
      ...
      <div className="p-3 py-4">
        {step === undefined ? <AddBasicInfo /> : null}

        {step === 'add-ssl-certificate' ? <AddSSL /> : null}
